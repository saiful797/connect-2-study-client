    ...
    >
      <div className="w-full lg:flex p-3 hero-overlay bg-opacity-60 text-white">
        <div className="lg:w-1/2 grid place-content-center mt-28 lg:mt-10 p-3">
            <h1 className="text-3xl font-bold text-[#18BC9C] mb-4">Together We Achieve More: Start Studying Collaboratively!</h1>
            ...
            <Link className="w-1/2 mt-20 mx-auto mb-10 lg:mb-0 hover:text-[#d47f4e] hover:border-[#d47f4e] hover:bg-[#eee9e6] text-[#18BC9C] btn btn-ghost btn-outline text-xl">
              Access Free Courses
            </Link>
        </div>
        <div className="lg:w-1/2 flex justify-center items-center lg:mt-28 relative">
          ...
          <div className="h-28 w-28 absolute rounded-full shadow-2xl shadow-[#18BC9C] border-4 border-white bg-[#18BC9C] top-10 right-10">
